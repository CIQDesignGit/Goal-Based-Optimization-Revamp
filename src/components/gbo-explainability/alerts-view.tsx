  ...
  return (
    <ExplainabilityPanel variant="flush">
      <div className="flex min-h-0 flex-1 divide-x divide-slate-200/80">
        ...
        >
          <div className="flex shrink-0 items-center justify-between gap-3 border-b border-slate-100/80 px-4 py-3">
          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-3">
            {dateGroups.map((group) => (
              ...
              >
                <header className="sticky top-0 z-10 mb-2 bg-slate-50/95 px-1 py-1.5 backdrop-blur-sm">

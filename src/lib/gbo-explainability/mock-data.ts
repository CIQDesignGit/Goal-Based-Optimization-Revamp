...
export const INITIAL_MOCK_ENTRIES: LogEntry[] = [
  ...
  // --- Setup: Emily's manual changes today (one alert card per change) ---
  {
    id: "setup-sess-001-a",
    tab: "setup",
    ...
    claim: "Monthly budget for JBC Fresh: $21.0k → $24.0k",
    reason: "Save & Launch session",
    impact: "Higher monthly budget set for JBC Fresh",
    summarySource: "human",
    entityName: "JBC Fresh",
    entityId: "brand-jbc-fresh",
    scopeLevel: "Brand",
  ...
  },
  {
    ...
    status: "success",
    actionType: "setup-change",
    claim: "Aggressiveness for JBC Fresh: Moderate → Aggressive",
    reason: "Save & Launch session",
    impact: "Goal aggressiveness increased for JBC Fresh",
    summarySource: "human",
    entityName: "JBC Fresh",
    entityId: "brand-jbc-fresh",
    scopeLevel: "Brand",
  ...
  },
  {
    ...
    status: "success",
    actionType: "setup-change",
    claim: "Bid optimization for JBC Fresh: None → Ally AI",
    reason: "Save & Launch session",
    impact: "Bid optimization enabled for JBC Fresh",
    summarySource: "human",
    entityName: "JBC Fresh",
    entityId: "brand-jbc-fresh",
    scopeLevel: "Brand",
